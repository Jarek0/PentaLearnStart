...
import com.pentalearn.pentalearnstart.database.Course.Chapter.Exercise.AnswerDB;
...
public class TaskDB {
    private static ArrayList<Task> tasks = new ArrayList<Task>(){{
        ...
        //test Exercise: chapter 2
        add(new Task(6, 2, "Poprawna pierwsza odwowidz", AnswerDB.getAnswersByTaskId(6)));
    }};
